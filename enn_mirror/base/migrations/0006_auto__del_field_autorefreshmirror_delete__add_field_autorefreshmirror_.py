...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AutoRefreshMirror.delet'
        db.add_column('base_autorefreshmirror', 'delet',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AutoRefreshMirror.delet'
        db.delete_column('base_autorefreshmirror', 'delet')
